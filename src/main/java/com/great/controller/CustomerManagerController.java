...
public class CustomerManagerController {
	...
	@ResponseBody
	public LayUITableResponseModel getCustomerList(String page,String limit,String salesManId,ConditionModel condition) {
		...
		ArrayList<BusPAXYDModel> customerList=customerManagerService.getCustomerList(queryInitCount, Integer.valueOf(limit).intValue(),salesManId,condition);

		int customerCount= Integer.valueOf(customerManagerService.getCustomerCount(salesManId,condition)).intValue();
...
//		editCustomerBus.setSalesManRemarkAndAdvice((String)Ognl.transferDateType(editCustomerBus.getSalesManRemarkAndAdvice()));
		...
		customerManagerService.editCustomerInfo(editCustomerBus);
