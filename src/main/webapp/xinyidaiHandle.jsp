        ...
        <div class="col-xs-12">
            <form class="form-horizontal">
                ...
                <div class="form-group" style="display:none;" id="house">
        			<label  class="col-xs-4 control-label text-right"><font color="#27408B">按揭月数：</font></label>
        			<div class="col-xs-6">
            		<input type="text" class="form-control" id="age" placeholder="房贷已按揭月数">
        			</div>
    			</div>
    			<div class="form-group" style="display:none;" id="warranty">
        			<label  class="col-xs-4 control-label text-right"><font color="#27408B">已缴次数：</font></label>
        			<div class="col-xs-6">
            		<input type="text" class="form-control" id="age" placeholder="保单已缴次数">
        			</div>
    			</div>
    			<div class="form-group" style="display:none;" id="money">
        			<label  class="col-xs-4 control-label text-right"><font color="#27408B">已缴年数：</font></label>
        			<div class="col-xs-6">
