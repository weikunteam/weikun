        ...
        <div class="col-xs-12">
            <form class="form-horizontal">
                ...
                <div class="form-group help">
                    <input type="password" class="form-control" id="inputPassword3" placeholder="请输入新密码(字母开头的6~12位组合)">
...
<%--                </div>--%>
                <div class="form-group">
                    <div class="form-inline">
                        <button type="button" class="btn btn-default" id="reset">确定</button>
...
<script src="${path}js/user/resetPassword.js"></script>
